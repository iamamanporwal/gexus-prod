# Contributing to GEXUS

When contributing to this repository, please first discuss the change you wish to make via [issues](https://github.com/iamamanporwal/gexus-prod/issues) before making a change.
