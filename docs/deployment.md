...
| Path                                                                                                                                      | Why                                                                                                                                                                                       |
| ----------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [src/components/NewProductBanner.tsx](../src/components/NewProductBanner.tsx)                                                             | Promotes `adam.new`, upstream's commercial product. Imported only by [src/views/PromptView.tsx](../src/views/PromptView.tsx).                                                             |
| [src/routes/\_layout/subscription.tsx](../src/routes/_layout/subscription.tsx)                                                            | Exists purely so upstream's `adam.new/cadam/subscription` links land somewhere. Meaningless on your domain.                                                                               |
| [src/routes/api/billing-checkout.ts](../src/routes/api/billing-checkout.ts), [billing-products.ts](../src/routes/api/billing-products.ts) | Stripe checkout against upstream's billing service. `billing-checkout` hard-codes `https://adam.new/app` as its fallback redirect ([line 13](../src/routes/api/billing-checkout.ts#L13)). |
| [src/config/billing.ts](../src/config/billing.ts)                                                                                         | Single export: `BILLING_URL = 'https://accounts.adam.new/billing'`.                                                                                                                       |
